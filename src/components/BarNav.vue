...
<nav>
    ...
    <div class="absolute-bg">
        <!-- <svg width="1920"  viewBox="0 0 1920 66" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <g>
                <path d="M1920 0H0V66H276.154C301.994 66 326.456 54.3482 342.74 34.2842C359.035 14.2059 383.52 2.55251 409.379 2.56845L1920 3.5V0Z" fill="#F7F2EC"/>
            </g>
            <rect x="46" y="10" width="132" height="44" fill="url(#pattern0)"/>
            <defs>
                <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
                    <use xlink:href="#image0_324_36" transform="matrix(0.00101626 0 0 0.00304878 0 -0.0228659)"/>
                </pattern>
    ...
    <div class="logo-mr">
        <svg width="35%" viewBox="0 0 1202 324" fill="none" xmlns="http://www.w3.org/2000/svg" height="100%">
            <g clip-path="url(#clip0_436_25)">
                ...
                <path d="M456.03 68.4098C453.33 65.7098 451.99 62.6798 451.99 59.1398C451.99 55.5998 453.34 52.3998 456.03 49.6998C458.73 47.1698 461.76 45.8198 465.3 45.8198C468.84 45.8198 471.87 47.1698 474.57 49.6998C477.27 52.2298 478.61 55.4298 478.61 59.1398C478.61 62.8498 477.26 65.7098 474.57 68.4098C471.87 71.1098 468.84 72.4498 465.3 72.4498C461.76 72.4498 458.73 71.0998 456.03 68.4098ZM455.69 92.6698H474.73V262.35H455.69V92.6798V92.6698Z" fill="#2B150C"/>
...
nav{
    ...
    background-image: url('@/assets/SegmentNav.png');
    background-repeat: no-repeat;
    background-size: contain;
    border-bottom : 1rem var(--color-mr-N) solid;
